...
#move_and_echo 3 1 "INICIO  1"            
move_and_echo 3 74 CHEGADA
#move_and_echo 1 5 "|"
move_and_echo 1 80 "|"
#move_and_echo 2 5 "|"
move_and_echo 2 80 "|"
...
# Some ASCII art.
move_and_echo 1 18 "$(figlet 'Cavalinhos')"
# move_and_echo 1 8 "..@@@..@@@@@...@@@@@.@...@..@@@@..."
# move_and_echo 2 8 ".@...@...@.......@...@...@.@......."
# move_and_echo 3 8 ".@@@@@...@.......@...@@@@@.@@@@...."
# move_and_echo 4 8 ".@...@...@.......@...@...@.@......."
...
tput cup 17 0
echo -e '\E[?25l'Precione [enter] para iniciar a corrida de cavalos ...
read -s
...
while [ $COL -lt $WINNING_POS ]; do
	  ...
	  `cat  horse_${MOVE_HORSE}_position | head -n 1` 
          ...
          echo -ne '\E[47m'
          tput cup 17 0
          echo -n Na frente: `grep -w $HIGHEST_POS *position | cut -c7`\
	  "                              "
...
# Make winner blink.
tput cup 17 0
echo -e "\E[5mVencedor: $MOVE_HORSE\E[25m""  Tempo: `cat odds_${MOVE_HORSE}`"\
"  Tempo de corrida: `expr $FINISH_TIME - $START_TIME` secs"
